...
export default {
    ...
    MAX_RETRIES_NOROMBO_RES: process.env.MAX_RETRIES_NOROMBO_RES,
    NOROMBO_URL: process.env.NOROMBO_URL,
    WHATSAPP_RECEPENT_NUMBER: process.env.WHATSAPP_RECEPENT_NUMBER,
    WHATSAPP_SERVICE_ENABLED: process.env.WHATSAPP_SERVICE_ENABLED,
    ...
    LOGS_PERCISTENT_FREQUENCY_IN_DAYS: process.env.LOGS_PERCISTENT_FREQUENCY_IN_DAYS,
    CACHE_TTL_IN_SECONDS: process.env.CACHE_TTL_IN_SECONDS
}
